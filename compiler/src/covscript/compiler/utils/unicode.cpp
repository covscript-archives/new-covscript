...
namespace cs {
    namespace compiler {
        struct CharacterDataLatin1 : public CharacterData {
            int A[256] = {0};

            constexpr static wchar_t A_DATA[] = (
                L"\u4800\u100F\u4800\u100F\u4800\u100F\u4800\u100F\u4800\u100F\u4800\u100F\u4800"
                "\u100F\u4800\u100F\u4800\u100F\u5800\u400F\u5000\u400F\u5800\u400F\u6000\u400F"
                "\u5000\u400F\u4800\u100F\u4800\u100F\u4800\u100F\u4800\u100F\u4800\u100F\u4800"
                "\u100F\u4800\u100F\u4800\u100F\u4800\u100F\u4800\u100F\u4800\u100F\u4800\u100F"
            ...
            constexpr static wchar_t B[] = (
                L"\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"
            ...
            CharacterDataLatin1() {
                // The length should be 512, but there is an '\0' at the end of the string
                static_assert((sizeof(A_DATA) / sizeof(A_DATA[0])) == ((256 * 2) + 1), "");
                int i = 0, j = 0;
                while (i < (256 * 2)) {
            ...
            int getProperties(int ch) override {
                wchar_t offset = static_cast<wchar_t>(ch);
                int props = A[offset];
                return props;
            }
            ...
            bool isOtherLowercase(int ch) override {
                int props = getPropertiesEx(ch);
                return (props & 0x0001) != 0;
            }

            bool isOtherUppercase(int ch) override {
                int props = getPropertiesEx(ch);
                return (props & 0x0002) != 0;
            }

            bool isOtherAlphabetic(int ch) override {
                int props = getPropertiesEx(ch);
                return (props & 0x0004) != 0;
            }

            bool isIdeographic(int ch) override {
                int props = getPropertiesEx(ch);
                return (props & 0x0010) != 0;
            }

            int getType(int ch) override {
                int props = getProperties(ch);
                return (props & 0x1F);
            }

            bool isWhitespace(int ch) override {
                int props = getProperties(ch);
                return ((props & 0x00007000) == 0x00004000);
            }

            bool isMirrored(int ch) override {
                int props = getProperties(ch);
                return ((props & 0x80000000) != 0);
            }

            bool isJavaIdentifierStart(int ch) override {
                int props = getProperties(ch);
                return ((props & 0x00007000) >= 0x00005000);
            }

            bool isJavaIdentifierPart(int ch) override {
                int props = getProperties(ch);
                return ((props & 0x00003000) != 0);
            }

            bool isUnicodeIdentifierStart(int ch) override {
                int props = getProperties(ch);
                return ((props & 0x00007000) == 0x00007000);
            }

            bool isUnicodeIdentifierPart(int ch) override {
                int props = getProperties(ch);
                return ((props & 0x00001000) != 0);
            }

            bool isIdentifierIgnorable(int ch) override {
                int props = getProperties(ch);
                return ((props & 0x00007000) == 0x00001000);
            }

            int toLowerCase(int ch) override {
                int mapChar = ch;
            ...
            int toUpperCase(int ch) override {
                int mapChar = ch;
                int val = getProperties(ch);
            ...
            int toUpperCaseEx(int ch) override {
                int mapChar = ch;
                int val = getProperties(ch);
            ...
            int toTitleCase(int ch) override {
            ...
            int getNumericValue(int ch) override {
                int val = getProperties(ch);
                int retval = -1;
            ...
            unsigned char getDirectionality(int ch) override {
                int val = getProperties(ch);
                auto directionality = static_cast<unsigned char>((val & 0x78000000) >> 27);
        ...
        struct CharacterData00 : public CharacterData {
            // The X table has 2048 entries for a total of 4096 bytes.
            constexpr static wchar_t X[] = (
                L"\000\020\040\060\100\120\140\160\200\220\240\260\300\320\340\360\200\u0100"
                "\u0110\u0120\u0130\u0140\u0150\u0160\u0170\u0170\u0180\u0190\u01A0\u01B0\u01C0"
            ...
            constexpr static wchar_t Y[] = (
                L"\000\000\000\000\002\004\006\000\000\000\000\000\000\000\010\004\012\014\016"
            ...
            CharacterData00() {
                static_assert((sizeof(A_DATA) / sizeof(A_DATA[0])) == ((930 * 2) + 1), "");
                int i = 0, j = 0;
                while (i < (930 * 2)) {
                    int entry = A_DATA[i++] << 16;
                    A[j++] = entry | A_DATA[i++];
        ...
        struct CharacterData01 : public CharacterData {

            // The X table has 2048 entries for a total of 4096 bytes.
            constexpr static wchar_t X[] = (
                L"\000\001\002\003\004\004\004\005\006\007\010\011\012\003\013\014\003\003\003"
            ...
            constexpr static wchar_t Y[] = (
                L"\000\000\000\000\000\000\001\000\000\000\000\000\000\000\000\000\000\000\000"
            ...
            int A[320] = {0};
            constexpr static wchar_t A_DATA[] =
                L"\000\u7005\000\u7005\u7800\000\000\u7005\000\u7005\u7800\000\u7800\000\u7800"
            ...
            CharacterData01() {
                static_assert((sizeof(A_DATA) / sizeof(A_DATA[0])) == ((320 * 2) + 1), "");
                int i = 0, j = 0;
                while (i < (320 * 2)) {
                    int entry = A_DATA[i++] << 16;
                    A[j++] = entry | A_DATA[i++];
        ...
        struct CharacterData02 : public CharacterData {
            // The X table has 2048 entries for a total of 4096 bytes.
            constexpr static wchar_t X[] = (
                L"\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"
                "\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"
            ...
            constexpr static wchar_t A_DATA[] =
                L"\000\u7005\000\u7005\000\u7005\u7800\000\u7800\000\u7800\000\000\u7725\000"
                "\u7005";

            // The B table has 8 entries for a total of 16 bytes.
            constexpr static wchar_t B[] = (
                L"\020\020\020\000\000\000\020\020");

            // In all, the character property tables require 4320 bytes.

            CharacterData02() {
                static_assert((sizeof(A_DATA) / sizeof(A_DATA[0])) == ((8 * 2) + 1), "");
                int i = 0, j = 0;
                while (i < (8 * 2)) {
                    int entry = A_DATA[i++] << 16;
                    A[j++] = entry | A_DATA[i++];
        ...
        struct CharacterData0E : public CharacterData {
            // The X table has 2048 entries for a total of 4096 bytes.

            constexpr static wchar_t X[] = (
                L"\000\020\020\020\040\040\040\040\060\060\060\060\060\060\060\100\040\040\040"
                "\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040"
                "\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040"
                "\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040"
                "\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040\040"
            ...
            constexpr static wchar_t Y[] = (
                L"\000\002\002\002\002\002\002\002\002\002\002\002\002\002\002\002\004\004\004"
        ...
        struct CharacterDataPrivateUse : public CharacterData {
            int getProperties(int ch) override {
                return 0;
            }
        ...
        struct CharacterDataUndefined : public CharacterData {
            int getProperties(int ch) override {
                return 0;
            }
        ...
        // C++11 says we have to provide the definition of the static member as well as the declaration.
        // The declaration and the initializer go inside the class definition,
        // but the member definition has to be separate.
        // This problem was fixed in C++17, but we are using C++14
        // See also: https://stackoverflow.com/questions/8016780/undefined-reference-to-static-constexpr-char

        // Remove the below code if we have switched to C++17
        constexpr wchar_t CharacterDataLatin1::A_DATA[];
        constexpr wchar_t CharacterDataLatin1::B[];
        constexpr wchar_t CharacterData00::A_DATA[];
        constexpr wchar_t CharacterData00::X[];
        constexpr wchar_t CharacterData00::Y[];
        constexpr wchar_t CharacterData00::B[];

        constexpr wchar_t CharacterData01::A_DATA[];
        constexpr wchar_t CharacterData01::X[];
        constexpr wchar_t CharacterData01::Y[];
        constexpr wchar_t CharacterData01::B[];

        constexpr wchar_t CharacterData02::A_DATA[];
        constexpr wchar_t CharacterData02::X[];
        constexpr wchar_t CharacterData02::Y[];
        constexpr wchar_t CharacterData02::B[];

        constexpr wchar_t CharacterData0E::A_DATA[];
        constexpr wchar_t CharacterData0E::X[];
        constexpr wchar_t CharacterData0E::Y[];
        constexpr wchar_t CharacterData0E::B[];
        // Remove the above code if we have switched to C++17

        CharacterData &CharacterData::of(int ch) {
            static CharacterDataLatin1 characterDataLatin1;
            static CharacterData00 characterData00;
            static CharacterData01 characterData01;
            static CharacterData02 characterData02;
            static CharacterData0E characterData0E;
            static CharacterDataPrivateUse characterDataPrivateUse;
            static CharacterDataUndefined characterDataUndefined;

            auto u = static_cast<unsigned int>(ch);

            if (u >> 8 == 0) {     // fast-path
                return characterDataLatin1;
            } else {
                switch (u >> 16) {  //plane 00-16
                    case (0):
                        return characterData00;
                    case (1):
                        return characterData01;
                    case (2):
                        return characterData02;
                    case (14):
                        return characterData0E;
                    case (15):   // Private Use
                    case (16):   // Private Use
                        return characterDataPrivateUse;
                    default:
                        return characterDataUndefined;
                }
            }
        }
    }
